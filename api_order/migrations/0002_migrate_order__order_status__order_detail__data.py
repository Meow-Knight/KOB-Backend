...
def initial_data(apps, schema_editor):
    ...
    order_details = [
        order_detail_model(amount=2, beer=beers[0], order=order_1, price=400000, discount_percent=30000),
        order_detail_model(amount=1, beer=beers[1], order=order_1, price=300000, discount_percent=30000),
        order_detail_model(amount=2, beer=beers[2], order=order_1, price=300000, discount_percent=30000)
    ]
    ...
    order_details.extend([
        order_detail_model(amount=1, beer=beers[3], order=order_2, price=250000, discount_percent=9000),
        order_detail_model(amount=1, beer=beers[2], order=order_2, price=250000, discount_percent=0)
    ])
    ...
    order_details.extend([
        order_detail_model(amount=4, beer=beers[4], order=order_3, price=1000000, discount_percent=40000),
        order_detail_model(amount=2, beer=beers[5], order=order_3, price=400000, discount_percent=25000),
        order_detail_model(amount=1, beer=beers[2], order=order_3, price=200000, discount_percent=35000),
        order_detail_model(amount=2, beer=beers[6], order=order_3, price=400000, discount_percent=10000)
    ])
    ...
    order_details.extend([
        order_detail_model(amount=2, beer=beers[7], order=order_4, price=600000, discount_percent=60000),
        order_detail_model(amount=1, beer=beers[8], order=order_4, price=400000, discount_percent=40000)
    ])
    ...
    order_details.extend([
        order_detail_model(amount=1, beer=beers[1], order=order_5, price=250000, discount_percent=20000),
        order_detail_model(amount=1, beer=beers[2], order=order_5, price=350000, discount_percent=30000)
    ])
    ...
    order_details.extend([
        order_detail_model(amount=3, beer=beers[5], order=order_6, price=1500000, discount_percent=30000),
        order_detail_model(amount=2, beer=beers[8], order=order_6, price=450000, discount_percent=50000),
        order_detail_model(amount=1, beer=beers[2], order=order_6, price=550000, discount_percent=20000),
        order_detail_model(amount=1, beer=beers[3], order=order_6, price=500000, discount_percent=20000)
    ])
    ...
    order_details.extend([
        order_detail_model(amount=1, beer=beers[3], order=order_7, price=300000, discount_percent=12000)
    ])
    ...
    order_details.extend([
        order_detail_model(amount=1, beer=beers[8], order=order_8, price=100000, discount_percent=0)
    ])
    ...
    order_details.extend([
        order_detail_model(amount=1, beer=beers[5], order=order_9, price=200000, discount_percent=10000)
    ])
    ...
    order_details.extend([
        order_detail_model(amount=1, beer=beers[10], order=order_10, price=200000, discount_percent=20000),
        order_detail_model(amount=1, beer=beers[11], order=order_10, price=300000, discount_percent=30000)
    ])
    ...
    order_details.extend([
        order_detail_model(amount=2, beer=beers[9], order=order_11, price=600000, discount_percent=40000),
        order_detail_model(amount=1, beer=beers[8], order=order_11, price=100000, discount_percent=10000)
    ])
    ...
    order_details.extend([
        order_detail_model(amount=1, beer=beers[0], order=order_12, price=300000, discount_percent=10000),
        order_detail_model(amount=1, beer=beers[1], order=order_12, price=200000, discount_percent=0),
        order_detail_model(amount=1, beer=beers[2], order=order_12, price=600000, discount_percent=10000),
        order_detail_model(amount=1, beer=beers[6], order=order_12, price=200000, discount_percent=10000)
    ])
    ...
    order_details.extend([
        order_detail_model(amount=1, beer=beers[7], order=order_13, price=250000, discount_percent=10000)
    ])
    ...
    order_details.extend([
        order_detail_model(amount=1, beer=beers[4], order=order_14, price=300000, discount_percent=0)
    ])
    ...
    order_details.extend([
        order_detail_model(amount=1, beer=beers[14], order=order_15, price=500000, discount_percent=30000),
        order_detail_model(amount=3, beer=beers[15], order=order_15, price=1200000, discount_percent=50000),
        order_detail_model(amount=2, beer=beers[13], order=order_15, price=800000, discount_percent=40000),
        order_detail_model(amount=1, beer=beers[12], order=order_15, price=500000, discount_percent=30000)
    ])
    ...
    order_details.extend([
        order_detail_model(amount=1, beer=beers[14], order=order_16, price=500000, discount_percent=10000),
        order_detail_model(amount=2, beer=beers[15], order=order_16, price=1000000, discount_percent=50000),
        order_detail_model(amount=1, beer=beers[13], order=order_16, price=500000, discount_percent=10000)
    ])
