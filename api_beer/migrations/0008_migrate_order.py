...
def initial_data(apps, schema_editor):
    ...
    order_status = order_status_model.objects.all()
    ...
    order = [
        order_model(total_price=120000, total_discount=10000, sum_price=110000,
                    ...
                    done_at=datetime(2022, 1, 14), order_status=order_status[1], user=user[1]),
        ...
        order_model(total_price=250000, total_discount=0, sum_price=250000,
                    ...
                    done_at=datetime(2022, 1, 14), order_status=order_status[2], user=user[2]),
        order_model(total_price=120000, total_discount=0, sum_price=120000,
                    ...
                    done_at=datetime(2022, 1, 14), order_status=order_status[3], user=user[2]),
        order_model(total_price=400000, total_discount=50000, sum_price=350000,
                    ...
                    done_at=datetime(2022, 1, 14), order_status=order_status[1], user=user[3]),
        order_model(total_price=320000, total_discount=20000, sum_price=300000,
                    ...
                    done_at=datetime(2022, 1, 14), order_status=order_status[3], user=user[3]),
        order_model(total_price=350000, total_discount=10000, sum_price=340000,
                    ...
                    done_at=datetime(2022, 1, 14), order_status=order_status[4], user=user[4]),
        order_model(total_price=250000, total_discount=0, sum_price=250000,
                    shipping_address="04 Hà Chương, Phường Phước Mỹ, Quận Sơn Trà, Tp.Đà Nẵng.",
                    shipping_phone="0359390209",
                    done_at=datetime(2022, 1, 14), order_status=order_status[5], user=user[3]),
        order_model(total_price=180000, total_discount=10000, sum_price=170000,
                    ...
                    done_at=datetime(2022, 1, 14), order_status=order_status[5], user=user[4]),
        order_model(total_price=230000, total_discount=10000, sum_price=220000,
                    ...
                    done_at=datetime(2022, 1, 14), order_status=order_status[6], user=user[5]),
