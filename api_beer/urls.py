...
from api_beer.views import BeerDetailViewSet, CartViewSet, BeerPhotoViewSet, CreateProducerViewSet, BeerUnitViewSet, \
    NationViewSet, BeerViewSet, BeerShipmentViewSet, DiscountViewSet, BeerDiscountViewSet
